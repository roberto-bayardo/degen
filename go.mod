module github.com/roberto-bayardo/degen

go 1.21.3

require (
	github.com/base-org/withdrawer v0.0.0-20231221203935-76ae514ce0ab
...
require (
	...
	github.com/ethereum-optimism/optimism v1.0.10-0.20230614200546-a541c8a859d9 // indirect
...
replace github.com/ethereum/go-ethereum v1.13.11 => github.com/ethereum-optimism/op-geth v1.101305.3
